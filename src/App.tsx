...
const CLERK_ROLES = [UserRole.CHURCH_ADMINISTRATOR, UserRole.PASTOR, UserRole.CHURCH_CLERK, UserRole.SUNDAY_SCHOOL_ADMIN, UserRole.GOODNEWS_TEACHER];
const CLERK_WRITE_ROLES = [UserRole.CHURCH_ADMINISTRATOR, UserRole.CHURCH_CLERK, UserRole.SUNDAY_SCHOOL_ADMIN, UserRole.GOODNEWS_TEACHER];
...
const AccessDenied: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 bg-white border border-red-100 rounded-2xl p-8 shadow-sm">
      ...
      <button
        onClick={() => navigate('/')}
        className="mt-6 px-4 py-2 rounded-lg bg-[var(--color-primary)] text-white hover:opacity-90"
      >
        Return to Dashboard
      </button>
    </div>
