...
import PracticeFormModal from "@/components/MusicMinistry/PracticeFormModal";
        ...
        <div className="space-y-6 pb-20 fade-in animate-in w-full">
            ...
            {isModalOpen && (
                <PracticeFormModal
                    ...
                    hasGroupedRosters={hasGroupedRosters}
                    saving={saving}
                    onSave={handleSave}
                    onClose={() => setIsModalOpen(false)}
                    onDeleteRequest={(id) => setConfirmDelete({ isOpen: true, id })}
                />
            )}
