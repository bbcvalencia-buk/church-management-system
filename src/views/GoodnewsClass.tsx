...
const GoodnewsClass = () => {
    ...
    return (
        <div className="max-w-[1200px] mx-auto space-y-6 pb-20 font-sans">
            {actionNotice && (
                <div className="bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-none flex items-center justify-between">
            ...
            <div className="flex justify-between items-start">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 tracking-tight flex items-center gap-3">
                        <BookOpen className="text-[var(--color-text-main)]" size={32} />
                        Goodnews Classes
                    </h1>
                ...
                {(canManageSessions || isTeacher) && !viewingSeries && (
                    <button
                        ...
                        className="px-5 py-2.5 bg-[var(--color-surface)] text-[var(--color-text-main)] border border-[var(--color-border)] text-[var(--color-text-main)] rounded-none font-bold hover:bg-[var(--color-surface-hover)] transition-colors flex items-center gap-2 shadow-sm"
                    >
            ...
            {!viewingSeries ? (
                        ...
                        {['ongoing', 'completed', 'paused'].map(tab => (
                            <button
                                ...
                                className={`px-6 py-3 font-bold text-sm tracking-wide capitalize transition-colors ${activeTab === tab
                                    ? 'text-[var(--color-text-main)] border-b-2 border-[var(--color-border)]'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {loading ? <p className="text-gray-500 col-span-full">Loading...</p> :
                            seriesList.filter(s => s.status === activeTab).length === 0 ?
                                <p className="text-gray-500 col-span-full py-8 text-center italic border border-dashed border-gray-200 rounded-none bg-gray-50">No {activeTab} Goodnews areas found.</p> :
                                seriesList.filter(s => s.status === activeTab).map(series => (
                                    <div
                                        key={series.id}
                                        onClick={() => loadSeriesDetails(series)}
                                        className="border border-gray-200 rounded-none p-5 hover:border-blue-300 hover:shadow-md transition-all cursor-pointer group bg-white shadow-sm flex flex-col"
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            <h3 className="font-black text-lg text-gray-900 group-hover:text-[var(--color-text-main)] transition-colors line-clamp-1">{series.area}</h3>
                                            <span className={`text-[10px] shrink-0 font-bold uppercase px-2 py-1 rounded-none ${series.status === 'ongoing' ? 'bg-green-100 text-green-700' :
                                        ...
                                        <div className="pt-4 mt-4 border-t border-gray-100 grid grid-cols-2 gap-4">
                                            <div className="bg-gray-50 rounded-none p-2 flex items-center gap-2">
                                            ...
                                            <div className="flex items-center justify-end text-[var(--color-text-main)] font-bold text-sm">
                ...
                <div className="space-y-6 animate-in fade-in zoom-in-95 duration-200">
                    <button
                        ...
                        className="flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-gray-900 transition-colors bg-white px-4 py-2 border border-gray-200 rounded-none shadow-sm w-max"
                    >
                    ...
                    <div className="bg-white rounded-[20px] shadow-sm border border-gray-100 p-8">
                        <div className="flex justify-between items-start">
                            <div>
                                <div className="flex items-center gap-3 mb-2">
                                    <span className={`px-3 py-1 rounded-none text-xs font-black uppercase tracking-wider ${viewingSeries.status === 'ongoing' ? 'bg-green-100 text-green-700' :
                                ...
                                <div className="flex items-center gap-4 mt-4 text-sm text-gray-600">
                                    ...
                                    <span className="flex items-center gap-1.5 bg-gray-50 px-3 py-1 rounded-none border border-gray-200">
                                ...
                                {viewingSeries.notes && (
                                    <p className="mt-4 text-gray-500 text-sm max-w-3xl leading-relaxed bg-gray-50 p-4 rounded-none border border-gray-100">{viewingSeries.notes}</p>
                                )}
                            </div>
                            <div className="flex flex-col gap-2">
                                {(canManageSessions || isTeacher) && (
                                    <button
                                        ...
                                        className="px-4 py-2 bg-gray-100 text-gray-700 rounded-none font-bold hover:bg-gray-200 transition-colors flex items-center gap-2 text-sm justify-center"
                                    >
                                ...
                                {(canManageSessions || isTeacher) && (
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[var(--color-surface)] text-[var(--color-text-main)] border border-[var(--color-border)] text-[var(--color-text-main)] rounded-none font-bold hover:bg-[var(--color-surface-hover)] transition-colors flex items-center gap-2 shadow-sm  text-sm justify-center"
                                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 p-6 bg-gray-50/50 rounded-none border border-gray-100">
                            <div className="flex items-center gap-4 bg-white p-4 rounded-none shadow-sm border border-gray-100">
                                <div className="p-3 bg-gray-50 rounded-none"><Calendar className="text-blue-500" size={24} /></div>
                                <div>
                            ...
                            <div className="flex items-center gap-4 bg-white p-4 rounded-none shadow-sm border border-gray-100">
                                <div className="p-3 bg-sky-50 rounded-none"><Users className="text-sky-500" size={24} /></div>
                                <div>
                            ...
                            <div className="flex items-center gap-4 bg-white p-4 rounded-none shadow-sm border border-gray-100">
                                <div className="p-3 bg-rose-50 rounded-none"><Heart className="text-rose-500" size={24} /></div>
                                <div>
                    ...
                    <div className="bg-white rounded-[20px] shadow-sm border border-gray-100 p-8">
                        ...
                        {seriesSessions.length === 0 ? (
                            <div className="text-center py-16 bg-gray-50/50 rounded-3xl border border-dashed border-gray-200">
                                <div className="w-16 h-16 bg-white rounded-none flex items-center justify-center mx-auto mb-4 shadow-sm border border-gray-100">
                            ...
                            <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 before:to-transparent">
                                {seriesSessions.map((session) => (
                                    <div key={session.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                        <div className="flex items-center justify-center w-10 h-10 rounded-none border-4 border-white bg-blue-100 text-[var(--color-text-main)] shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 font-black text-sm absolute left-0 md:left-1/2">
                                            #{session.session_number}
                                        </div>
                                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-none border border-gray-100 bg-white shadow-sm hover:shadow-md hover:border-blue-200 transition-all ml-12 md:ml-0">
                                            <div className="flex justify-between items-start mb-4 gap-4">
                                                <div>
                                                    <h4 className="font-bold text-gray-900 flex flex-col gap-1">
                                                        <span className="text-sm text-[var(--color-text-main)] bg-gray-50 px-2 py-0.5 rounded-none w-max">
                                            ...
                                            <div className="grid grid-cols-2 gap-3 mb-6 bg-gray-50/50 p-3 rounded-none border border-gray-100">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-none bg-sky-100 text-sky-600 flex items-center justify-center shrink-0">
                                                        <Users size={14} />
                                                    </div>
                                                    <div>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-none bg-rose-100 text-rose-600 flex items-center justify-center shrink-0">
                                                        <Heart size={14} />
                                                    </div>
                                                    <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {session.members && session.members.length > 0 ? (
                                                        session.members.map((m: any, idx: number) => (
                                                            <div key={idx} className="bg-white border border-gray-100 rounded-none px-2.5 py-1.5 flex items-center gap-2 shadow-sm">
                                                                <div className="w-5 h-5 rounded-none bg-gray-100 text-gray-600 flex items-center justify-center text-[9px] font-bold">
                                                        ...
                                                        <span className="text-xs text-gray-400 italic bg-gray-50 px-3 py-1 rounded-none border border-gray-100">No members marked.</span>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
            ...
            {/* Series Form Modal */}
            {
                showSeriesForm && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm font-sans animate-in fade-in duration-200">
                        <div className="bg-white rounded-none shadow-2xl w-full max-w-lg flex flex-col max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-300">
                            <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                <h2 className="text-xl font-bold flex items-center gap-2 text-gray-900">
                                    <BookOpen size={20} className="text-[var(--color-text-main)]" />
                                    {seriesForm.id ? 'Edit Goodnews Area' : 'Create Goodnews Area'}
                                </h2>
                                <button onClick={() => setShowSeriesForm(false)} className="text-gray-400 hover:text-gray-600 transition-colors p-1 bg-white rounded-none border border-gray-200">
                                    <X size={20} />
                                </button>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-gray-50 border border-gray-200 rounded-none p-3 text-sm text-gray-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white outline-none transition-all"
                                        />
                                    </div>
                                    <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-gray-50 border border-gray-200 rounded-none p-3 text-sm text-gray-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white outline-none transition-all font-bold"
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full disabled:bg-gray-100 disabled:text-gray-400 bg-gray-50 border border-gray-200 rounded-none p-3 text-sm text-gray-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white outline-none transition-all"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="p-4 px-6 border-t border-gray-100 flex items-center justify-between bg-gray-50/50">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="px-4 py-2 font-bold text-sm text-gray-600 hover:bg-gray-100 rounded-none transition-colors"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        className="px-6 py-2 bg-[var(--color-surface)] text-[var(--color-text-main)] border border-[var(--color-border)] text-[var(--color-text-main)] rounded-none font-bold shadow-sm hover:bg-[var(--color-surface-hover)] transition-colors disabled:opacity-50"
                                    >
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm font-sans animate-in fade-in duration-200">
                        <div className="bg-white rounded-none shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-300">
                            <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                ...
                                <button onClick={() => setShowSessionForm(false)} className="text-gray-400 hover:text-gray-600 transition-colors p-1 bg-white rounded-none border border-gray-200">
                                    <X size={20} />
                                </button>
                            </div>
                            ...
                            <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-1 space-y-6">
                                <div className="grid grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white border border-gray-200 rounded-none p-3 text-lg font-bold text-gray-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all shadow-sm"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white border border-gray-200 rounded-none p-3 text-lg text-gray-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all shadow-sm"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-6 p-4 rounded-none border border-gray-100 bg-gray-50/50">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white border border-sky-200 rounded-none p-3 text-center text-2xl font-black text-sky-700 focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 outline-none shadow-sm"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white border border-rose-200 rounded-none p-3 text-center text-2xl font-black text-rose-700 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 outline-none shadow-sm"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="border-t border-gray-100 pt-6">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <button
                                            ...
                                            className="text-[10px] font-bold text-[var(--color-text-main)] uppercase tracking-widest bg-gray-50 px-3 py-1.5 rounded-none border border-blue-100 hover:bg-blue-100 transition-colors"
                                        >
                                            + Add Member
                                        </button>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        {sessionMembers.length === 0 ? (
                                            <p className="text-xs text-gray-400 italic text-center p-4 border border-dashed border-gray-200 rounded-none bg-gray-50/50">No members added to this session yet.</p>
                                        ) : (
                                            sessionMembers.map((sm, index) => (
                                                <div key={index} className="flex gap-2 items-start bg-gray-50/50 p-2.5 rounded-none border border-gray-100 group">
                                                    <div className="flex-1 space-y-2">
                                                        <div className="flex gap-2">
                                                            <select
                                                                ...
                                                                className="flex-1 bg-white border border-gray-200 rounded-none p-2 text-xs font-bold text-gray-900"
                                                            >
                                                            ...
                                                            <select
                                                                ...
                                                                className="w-[120px] bg-white border border-gray-200 rounded-none p-2 text-xs font-bold text-gray-700 uppercase tracking-wide"
                                                            >
                                                                {ROLES.map(r => (
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-white border border-gray-200 rounded-none p-2 text-xs text-gray-600"
                                                        />
                                                    </div>
                                                    <button
                                                        type="button"
                                                        ...
                                                        className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-none transition-colors mt-0.5"
                                                        title="Remove"
                                                    >
                                                        <X size={16} />
                                                    </button>
                            ...
                            <div className="p-4 px-6 border-t border-gray-100 flex items-center justify-end gap-3 bg-gray-50/50">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-green-600 text-[var(--color-text-main)] rounded-none font-bold shadow-sm hover:bg-green-700 transition-colors disabled:opacity-50"
                                >
