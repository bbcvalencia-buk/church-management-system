                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                {Object.entries(serviceAssignments.reduce((acc: any, curr: any) => {
                                    ...
                                    <div key={role} className="bg-indigo-50/50 border border-indigo-100/50 p-4 rounded-none transition-all hover:bg-indigo-50">
                    ...
                    {goodnewsAssignments.length > 0 ? (
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-green-50/50 border border-green-100/50 p-4 rounded-none transition-all hover:bg-green-50">
                                    ...
                                    <tbody className="divide-y divide-gray-50">
                                        {goodnewsAssignments.map((a, i) => (
                                            <tr key={i} className="hover:bg-gray-50/30 transition-colors group">
                                                ...
                                                <td className="px-6 py-5">
                                                    <span className="inline-flex items-center px-3 py-1 rounded-none bg-green-100 text-green-700 font-black uppercase text-[10px] tracking-tight">{a.role.replace(/_/g, ' ')}</span>
                                                </td>
                                                <td className="px-6 py-5 text-right">
                                                    <p className="text-sm text-gray-500 italic font-medium">{a.notes ? `"${a.notes}"` : '—'}</p>
                                                </td>
            ...
            <div className="lg:col-span-4 space-y-6">
                <div className="bg-white rounded-[20px] shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 rounded-none bg-green-50/50 border border-green-100 flex items-center justify-between">
                            <div>
                ...
                <div className="bg-indigo-600 rounded-[20px] p-6 text-[var(--color-text-main)] shadow-lg shadow-indigo-500/20">
                    ...
                    <div className="h-2 bg-indigo-900/30 rounded-none overflow-hidden">
                        <div
                            className="h-full bg-indigo-200 rounded-none transition-all duration-1000"
