...
const PositionsForm: React.FC<PositionsFormProps> = ({ data, onChange }) => {
    ...
    return (
        <div className="space-y-6">
            <div className="rounded-none border border-gray-100 bg-gray-50/40 p-4 sm:p-5">
            ...
            <div className="space-y-3">
                ...
                {positions.map((pos: any, idx: number) => (
                    <div key={idx} className="rounded-none border border-gray-100 bg-white p-4">
                        <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                                <div className="flex items-center gap-2">
                                    ...
                                    {pos.is_ministry_head && (
                                        <span className="inline-flex items-center gap-1 text-[10px] font-bold text-amber-700 bg-amber-50 border border-amber-100 rounded-none px-2 py-1">
                            ...
                            <button
                                ...
                                className="p-2 text-red-500 hover:bg-red-50 rounded-none transition-colors"
